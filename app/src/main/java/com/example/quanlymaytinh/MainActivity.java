...
import com.example.quanlymaytinh.Control.Database;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor.getCount()==0){
            db.insertCa("Ca01","Dell");
            db.insertCa("Ca02","Lenovo");
            db.insertCa("Ca03","Asus");
            db.insertCa("Ca04","Acer");
            db.insertCa("Ca05","Macbook");

        }
        cursor = db.GetData("select * from Computer");
        if (cursor.getCount()==0){
            db.insertC("Computer01","Dell Gaming G15 5515 R5 5600H","Ca01");
            db.insertC("Computer02","Dell Vostro","Ca01");
            db.insertC("Computer03","Dell Latitude","Ca01");
            db.insertC("Computer04","Dell Precision","Ca01");


            db.insertC("Computer05","Lenovo Thinkpad","Ca02");
            db.insertC("Computer06","Lenovo IdeaPad","Ca02");
            db.insertC("Computer07","Lenovo Gaming Legion","Ca02");
            db.insertC("Computer08","Lenovo Essential","Ca02");



            db.insertC("Computer11","MacBook Pro M1","Ca05");
            db.insertC("Computer12","MacBook Pro 14 M1 Pro","Ca05");
        }
        ...
        lvCategory.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                alertDiaLog.setMessage("Bạn có muốn xóa "+categories.get(i).getIdCategory()+" không?"    );
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.category_new);
                dialog.show();
