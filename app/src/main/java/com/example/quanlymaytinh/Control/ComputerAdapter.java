package com.example.quanlymaytinh.Control;
...
import com.example.quanlymaytinh.ListComputer;
...
public class ComputerAdapter extends RecyclerView.Adapter<ComputerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.computer_item, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.idcomputer.setText(computer.getIdComputer());
        holder.nameCo.setText(computer.getNameComputer());
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView idcomputer;
        public TextView nameCo;
        public ImageView btnDel,btnEdit;

        public ViewHolder(View itemView) {
            super(itemView);
            itemview = itemView;
            idcomputer = itemView.findViewById(R.id.idname);
            nameCo = itemView.findViewById(R.id.namecomputer);
            ...
            btnDel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    alertDiaLog.setMessage("Bạn có muốn xóa "+ idcomputer.getText().toString().trim()+" không?"    );
                    alertDiaLog.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ListComputer.db.QueryData("delete from Computer where idComputer ='"+idcomputer.getText().toString().trim()+"'");
            ...
            btnEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dialog.setContentView(R.layout.computer_new);
                    dialog.show();
                    ...
                    btok.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            ListComputer.db.QueryData("update Computer set idComputer = '"+tv1.getText().toString().trim()+ "',nameComputer='"+ tv2.getText().toString().trim()+ "'  where idComputer ='"+idcomputer.getText().toString().trim()+"'");
                            ListComputer.computers = new ArrayList<Computer>();
                            Cursor cursor = ListComputer.db.GetData("Select * from Computer where idCategory = '"+ListComputer.idTruyen.toString().trim() +"'");
                            while (cursor.moveToNext()){
                                @SuppressLint("Range") String idC =cursor.getString(cursor.getColumnIndex("idComputer"));
